            ...
            <div class="m-portlet m-portlet--full-height  ">
                <div class="m-portlet__body">
                    <div class="m-card-profile">
                        <div class="m-card-profile__title m--hide">Your Profile - <?php echo $profile_id; ?></div>
                        <div class="m-card-profile__pic">
                            <div class="m-card-profile__pic-wrapper">
                                <img src="../../../assets/app/media/img/users/user4.jpg" alt=""/>
                            </div>
                        </div>
                        <div class="m-card-profile__details"><span
                                class="m-card-profile__name"><?php echo $current_profile->fullname ?></span>
            ...
            <div class="m-portlet m-portlet--full-height m-portlet--tabs  ">
                        ...
                        <ul class="nav nav-tabs m-tabs m-tabs-line   m-tabs-line--left m-tabs-line--primary"
                            ...
                            <li class="nav-item m-tabs__item">
                                <a class="nav-link m-tabs__link active" data-toggle="tab" href="#m_user_profile_tab_1"
                                   role="tab"><i class="flaticon-share m--hide"></i>Update Profile</a>
                            </li>
                            <li class="nav-item m-tabs__item">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="m_user_profile_tab_1">
                        <form class="m-form m-form--fit m-form--label-align-right" action="user/update_profile"
                              method="post">
                            <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-7">
                                        <input class="form-control m-input" title="Full Name" type="text"
                                               name="profile_fullname" value="<?php echo $current_profile->fullname ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-7">
                                        <input class="form-control m-input" title="Address" type="text"
                                               name="profile_address" value="<?php echo $current_profile->address ?>">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <label for="example-text-input" class="col-2 col-form-label">City</label>
                                    <div class="col-7">
                                        <input class="form-control m-input" title="City" type="text" name="profile_city"
                                               value="<?php echo $current_profile->city ?>">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <label for="example-text-input" class="col-2 col-form-label">State</label>
                                    <div class="col-7">
                                        <input class="form-control m-input" title="State" type="text"
                                               name="profile_state" value="<?php echo $current_profile->state ?>">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <label for="example-text-input" class="col-2 col-form-label">Zipcode</label>
                                    <div class="col-7">
                                        <input class="form-control m-input" title="Zipcode" type="text"
                                               name="profile_zip" value="<?php echo $current_profile->zip ?>">
                                    </div>
                                </div>
                                <div class="m-form__seperator m-form__seperator--dashed m-form__seperator--space-2x"></div>
                                <div class="form-group m-form__group row">
