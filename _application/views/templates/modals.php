...
?>
<!--begin::Modal-->
<div class="modal fade" id="m_modal_new_league" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="user/create_league" method="post">
...
<div class="modal fade" id="m_modal_new_team" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="user/create_team" method="post">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="team_name" class="form-control-label">Name</label>
                        <input type="text" class="form-control" id="team_name" name="team_name">
                    </div>
                    <div class="form-group">
                        <div class="m-select2 m-select2--air m-select2--pill" >
                            <select class="form-control m-select2" style="width: 300px" id="m_select2_LeagueSelect" name="teamRoster" data-placeholder="Air & pill styles">
                                <option></option>
                                <?php
